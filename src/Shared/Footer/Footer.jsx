...
function Footer() {
  const gitHubUrl = "https://github.com/Shivam1272"
  const instagramUrl = "https://www.instagram.com/im.shivampatel/"
  const linkedinUrl = "https://www.linkedin.com/in/shivam-patel-b06b11214/"
  ...
  return (
    <footer className="footer items-center p-4 bg-neutral text-neutral-content">
      ...
      <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        <a href={gitHubUrl} target="_blank"  rel="noreferrer" ><i style={{fontSize: '24px'}} class="fab fa-github"/></a>
        <a href={instagramUrl} target="_blank"  rel="noreferrer"><i style={{fontSize: '24px'}} class="fab fa-instagram"/></a>
        <a href={linkedinUrl} target="_blank"  rel="noreferrer"><i style={{fontSize: '24px'}} class="fab fa-linkedin"/></a>
      </div>
  </footer>
  )
}
